...
left by me.</p>
            ...
            @foreach(@$witness as $val)
                <tr>
                    ...
                    <td class="width-22">
                    <p style="text-align:left;margin-top: -20px;"><b>Name:</b> {{@$val->salutation}} {{@$val->name}}</p>
                    @if(@$val->aadhar_number)<p style="text-align:left;margin-top: -20px;"><b>Aadhaar Card No:</b> {{@$val->aadhar_number}}</p>@endif
                    <p style="text-align:left;margin-top: -20px;"><b>Address:</b> {{@$val->address1}}, {{@$val->address2}}, {{@$val->city}} - {{@$val->zip_code}}, {{@$val->state}}, {{@$val->getCountry->name}}</p>
                    {{--<p style="text-align:left;margin-top: -20px;"><b>Place of Signature:</b> </p>--}}
                    </td>
                    <td class="width-33">
