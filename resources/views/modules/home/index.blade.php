...
<section class="block">
    <div class="container">
        <div class="section-title sec-big-ttl d-flex flex-wrap">
            ...
            <p class="w-100">Will & More provides you with a facility to create a Will using our secure online
                Will creation tool; we also help you register the location of your Will so that your loved ones can
                locate it easily after your passing. In case you need further advice and help with writing your Will,
                we have a facility to make a custom made Will with the help our legal experts
            </p>
            <p class="w-100 mt-2">We also provide a facility to record a Letter of Instructions to your loved ones in case you become
                incapacitated due to an accident or disease and to store it with us safely, securely and confidentially.
            </p>
            <p class="w-100 mt-2">We can also help you prepare an Advance Medical Directive (also known as “Living Will”)
                in case you do not wish to continue with life sustaining medical treatment for a terminal illness.
            </p>
        ...
        <div class="posts">
            <div class="row align-items-strech">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="post pack_post mh-707" style="height:calc(100% - 30px)">
...
<section class="block">
    <div class="container">
        <div class="section-title d-flex flex-wrap align-items-end">
            <h2 class="h-title dark-clr mw-40">Blogs</h2>
        ...
        <div class="blog-posts">
            <div class="row">
                ...
                @if(@$blog)
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog-post-lg overlay wow slideInLeft black_bg" data-wow-duration="1000ms">
                        {{-- <img src="https://via.placeholder.com/444x573" alt="" class="w-100"> --}}
                        @if(@$blog->home_image)
                            <img src="{{url('storage/app/blog_cata_img/home_img')}}/{{ @$blog->home_image }}" alt="" class="w-100">
                        @else
                            <img src="{{asset('public/images/logo_blog.png')}}" alt="" class="w-100">
                        @endif
