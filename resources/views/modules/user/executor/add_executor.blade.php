        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                @include('includes.message')
                    <form id="executor-form" method="POST" action="{{ route('save.executor') }}">
                        @csrf
                        ...
                        <div class="row login_rm02 for_dashboard">
                            ...
                            <div class="col-lg-8 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exe_willcreator_relation" class="rm_form_fild" placeholder="Enter here"
                                        value="{{old('exe_willcreator_relation')}}">
                                </div>
                            </div>
                            ...
                            {{-- displaying Generate and Download PDF button --}}
                                ...
                                {{--<p>If you wish to add another executor, please click "Save" and add another executor.</p>--}}
                            </div>
...
$(document).ready(function() {
    ...
    $("#executor-form").validate({
        rules: {
            ...
            exe_willcreator_relation:{required: true,maxlength:200},
