        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex nwdes-sec">
                    <h2>Edit @if(@$locPack->package_id ==1 )Beneficiaries @elseif(@$locPack->package_id == 5) Trusted Person @else Nominee @endif</h2>
                ...
                @include('includes.message')
                    ...
                    <form id="beneficiar-form" method="POST" action="{{ route('update.beneficiaries') }}">
                        @csrf

                        <input type="hidden" class="rm_form_fild" name="will_id" id="will_id" value="{{@$will_id}}">
                        <input type="hidden" class="rm_form_fild" name="id" id="id" value="{{@$beneficiarDetail->id}}">
                        @if(@$locPack->package_id !=1 )
                        <input type="hidden" class="rm_form_fild" name="is_new_person" value="{{@$beneficiarDetail->is_new_person}}">
                        @endif
                        <div class="row login_rm02 for_dashboard">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="rm_form_fild" placeholder="Enter Here" name="first_name"
                                        value="{{@$beneficiarDetail->first_name}}">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="rm_form_fild" placeholder="Enter Here" name="middle_name"
                                        value="{{@$beneficiarDetail->middle_name}}">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="rm_form_fild" placeholder="Enter Here" name="last_name"
                                        value="{{@$beneficiarDetail->last_name}}">
                            ...
                            {{-- <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="aadhar_number" class="rm_form_fild" id="aadhar_number"
                                        placeholder="Enter here" value="{{@$beneficiarDetail->aadhar_number}}">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="doc_type" id="doc_type" class="rm_form_fild">
                                        <option value="1" {{!is_null(@$beneficiarDetail->aadhar_number) ? 'selected':''}}>Aadhar</option>
                                        <option value="2" {{!is_null(@$beneficiarDetail->pan_number) ? 'selected':''}}>PAN</option>
                                        <option value="3" {{!is_null(@$beneficiarDetail->passport_number) ? 'selected':''}}>Passport</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    name="card_number" value="{{@$beneficiarDetail->aadhar_number!=null ? @$beneficiarDetail->aadhar_number :  (@$beneficiarDetail->pan_number!=null ? @$beneficiarDetail->pan_number :  @$beneficiarDetail->passport_number)}}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="text" class="rm_form_fild" placeholder="Enter here"
                                         value="{{@$beneficiarDetail->email}}" autocomplete="email">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                    ...
                                    <label>Mobile number <span class="text-danger">*</span></label>
                                                <div class="phonecode-sec">
                                                    <select class="input_form_login p_input rm_form_fild" name="phonecode" id="singleSelectExample">
                                                            ...
                                                            <option value="{{$phonecode->id}}" @if(@$beneficiarDetail->phonecode == @$phonecode->id) selected @elseif($phonecode->phonecode == 91) selected @endif >+{{$phonecode->phonecode}}</option>
                                                            @endforeach
                                                    </select>
                                                </div>
                                    <input type="text" placeholder="Enter here" name="mobile" id="mobile"
                                        class="rm_form_fild @error('mobile') is-invalid @enderror"
                                        value="{{@$beneficiarDetail->mobile}}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="input_form_login p_input rm_form_fild" name="nationality"
                                        ...
                                        <option phonecode="{{ $n->phonecode }}" value="{{$n->id}}" {{@$beneficiarDetail->nationality == $n->id ? 'selected' : ''}} id="shop-n">
                                            {{$n->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="rm_form_fild" name="user_relation" id="user_relation">
                                        ...
                                        <option value="S" {{@$beneficiarDetail->user_relation == 'S' ? 'selected' : ''}}>Son of</option>
                                        <option value="W" {{@$beneficiarDetail->user_relation == 'W' ? 'selected' : ''}}>Wife of</option>
                                        <option value="D" {{@$beneficiarDetail->user_relation == 'D' ? 'selected' : ''}}>Daughter of</option>
                                        <option value="H" {{@$beneficiarDetail->user_relation == 'H' ? 'selected' : ''}}>Husband of</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label id="relat_name">
                                        @if(@$beneficiarDetail->user_relation == 'S')
                                            Fathers Name
                                        @elseif(@$beneficiarDetail->user_relation == 'W')
                                            Husbands Name
                                        @elseif(@$beneficiarDetail->user_relation == 'D')
                                            Fathers Name
                                        @elseif(@$beneficiarDetail->user_relation == 'H')
                                            Wifes Name
                                        @endif
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="relationship" class="rm_form_fild" placeholder="Enter here"
                                        value="{{@$beneficiarDetail->relationship}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="input_form_login p_input rm_form_fild" name="country_id"
                                        ...
                                        <option phonecode="{{ $country->phonecode }}" value="{{$country->id}}"
                                            id="shop-country" {{@$beneficiarDetail->country == $country->id ? 'selected' : ''}}>{{$country->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address1" class="rm_form_fild" placeholder="Enter here"
                                        value="{{@$beneficiarDetail->address1}}">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address2" class="rm_form_fild" placeholder="Enter here"
                                        value="{{@$beneficiarDetail->address2}}">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="zip_code" class="rm_form_fild" placeholder="Enter here"
                                        value="{{@$beneficiarDetail->zip_code}}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                @if(@$locPack->package_id !=1 )
                                    <button type="submit" name="newperson" class="submit_rm bntt_collor" @if(@$locPack->package_id ==5 ) value="T" @else value="Y" @endif>Update</button>
                                @endif
                            </div>
                            ...
                            <p>If you wish to add another @if(@$locPack->package_id ==1 )beneficiary @elseif(@$locPack->package_id == 5) Trusted Person @else nominee @endif, please click "Update" and add another @if(@$locPack->package_id ==1 )beneficiary @elseif(@$locPack->package_id == 5) Trusted Person @else nominee @endif.</p>
                            </div>
