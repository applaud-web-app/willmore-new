        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="bank_form" method="POST" action="{{ route('save.bank')}}">
                        @csrf
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_name" value="{{old('bank_name')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="branch_address" value="{{old('branch_address')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ifsc_code" value="{{old('ifsc_code')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="account_type">
                                            ...
                                            <option value="Recurring deposits"> Recurring deposits </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_holder_name" value="{{old('account_holder_name')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another bank account, please click "Save" and add another bank account.
