        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex nwdes-sec">
                    ...
                    <p>Add at least two witnesses to complete the will.</p>
                ...
                @include('includes.message')
                    ...
                    <form id="beneficiaries-form" method="POST" action="{{ route('save.witness') }}">
                        @csrf
                        ...
                        <div class="row login_rm02 for_dashboard">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sign_place" class="rm_form_fild"
                                        placeholder="Enter here" value="{{old('sign_place')}}">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group signDate">
                                    <label>Date of Signature <span class="text-danger">*</span></label>
                                        <input type="text" name="sign_date" value="{{old('sign_date')}}" class="rm_form_fild calandar_iconn sign_date"
                            ...
                            <p>If you wish to add another witness, please click "Save" and add another witness.
