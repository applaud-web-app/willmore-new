        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="other_form" method="POST" action="{{ route('save.otherAssets')}}">
                        @csrf
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another any other assets, please click "Save" and add another any other assets.
