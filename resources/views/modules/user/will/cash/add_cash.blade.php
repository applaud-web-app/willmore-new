        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex nwdes-sec">
                    <h2>Manage (Cash & Equivalent) <img src="{{asset('public/images/pagright.png')}}" alt="icon"> Add Cash</h2>
                    {{-- <a href="{{route('user.manage.cash',[@$will_id])}}" class="top_battn_new">Back</a> --}}
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="cash_form" method="POST" action="{{ route('save.cash')}}">
                        @csrf
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="amount" value="{{old('amount')}}" min="1" class="rm_form_fild cashAmt" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="amount_in_words" value="{{old('amount_in_words')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location_of_cash" value="{{old('location_of_cash')}}"  class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                    ...
                                    <div class="add_bene_name">
                                       ...
                                       <div class="mr-2"><p>Click on "ADD" button to save the beneficiary information and then click on the "Save" button to save your assets information.</p></div>
                                        ...
                                        <div class="col-lg-12 col-md-12 beneficiaries_headingg">
                                            ...
                                            <span class="error ben_err mb-2" style="display:none;">Please add atleast one beneficiaries</span>
                                        </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another cash asset, please click "Save" and add another cash asset.
...
$(document).ready(function() {
    ...
    $("#cash_form").validate({
        rules: {
            ...
            amount_in_words: {
                name_Regex:true,required: true,maxlength:200
            },
            location_of_cash: {
