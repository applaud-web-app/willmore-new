        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="vehicles_form" method="POST" action="{{ route('save.vehicles')}}">
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label>Make & Model name <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="registration_number"
                                            value="{{old('registration_number')}}" class="rm_form_fild"
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another vehicle, please click "Save" and add another vehicle.
...
$(document).ready(function() {
    ...
    $("#vehicles_form").validate({
        rules: {
            ...
            registration_number: {
                required: true,alphanumeric: true,maxlength:30
            },
            manufacture_year: {
                required: true
            },
