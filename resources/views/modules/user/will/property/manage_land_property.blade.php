        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex des-chng">
                    ...
                    <h2>Manage Land Property</h2>
                    <p>If you wish to add a new beneficiary please add that before adding the asset details.</p>
                    <a href="{{route('user.add.land',[@$will_id])}}" class="top_battn_new">Add Land Property
                    </a>
                </div>
                ...
                <div class="dash-right-inr des-ch-btn">
                    ...
                    <div class="col-lg-12 mb-4 mt-1 tabble_ress">
                        <div class="table_01 table">
                            ...
                            <div class="row amnt-tble">
                                ...
                                <div class="cel_area amunt cess">Land Type</div>
                                <div class="cel_area amunt cess">Land Area</div>
                            ...
                            <div class="row small_screen2 for_bg_color_01 table_box">
                                ...
                                <div class="cel_area amunt-detail cess"> <span class="hide_big">Land Type</span> <span class="sm_size">{{@$val->land_type}}</span></div>
                                <div class="cel_area amunt-detail cess"> <span class="hide_big">Land Area</span>
                                    <span class="sm_size">@if(@$val->plot_size) {{@$val->plot_size}} {{@$val->land_area_unit}} @else - @endif</span>
                                </div>
                                ...
                                <div class="cel_area amunt-detail cess"> <span class="hide_big">Action</span>
                                    <ul>
                                        <li><a href="{{url('view-land-property/'.@$will_id.'/'.@$val->id)}}" class="css-tooltip-top color-blue"><span>Edit</span>
                                                <img src="{{asset('public/images/edit.png')}}" alt=""></a></li>
                                        <li><a href="javascript:;" class="css-tooltip-top color-blue delete_land" data-id="{{@$val->id}}"><span>Delete</span>
                    ...
                    <div class="pdf_box">
                    <a href="{{route('user.add.land',[@$will_id])}}" class="submit_rm bntt_collor pdf_btn">
                        @if(count(@$properties) > 0)
                        Add another Land Property
                        @else
                        Add Land Property
                        @endif
                    </a>
    ...
    $('.delete_land').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{url('delete-land')}}/" + id;
            } else {
                return false;
            }
        });
