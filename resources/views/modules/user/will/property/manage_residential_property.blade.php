@extends('layouts.app')
@section('title','Manage Residentials Property')
@section('links')
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex des-chng">
                    ...
                    <h2>Manage Residential Property</h2>
                    <p>If you wish to add a new beneficiary please add that before adding the asset details.</p>
                    <a href="{{route('user.add.residentials',[@$will_id])}}" class="top_battn_new">Add Residential
                        Property</a>
                </div>
                ...
                <div class="dash-right-inr des-ch-btn">
                        ...
                        <div class="table_01 table">
                            ...
                            <div class="row small_screen2 for_bg_color_01 table_box">
                                <div class="cel_area amunt-detail cess"> <span class="hide_big">Name of the property</span>
                                    <span class="sm_size">{{@$val->name ? @$val->name : "-"}}</span>
                                </div>
                                ...
                                <div class="cel_area amunt-detail cess"> <span class="hide_big">Area (Sq ft)</span>
                                ...
                                <div class="cel_area amunt-detail cess"> <span class="hide_big">Action</span>
                                    <ul>
                                        <li><a href="{{url('view-residential-property/'.@$will_id.'/'.@$val->id)}}" class="css-tooltip-top color-blue"><span>Edit</span>
                                                <img src="{{asset('public/images/edit.png')}}" alt=""></a></li>
                                        <li><a href="javascript:;" class="css-tooltip-top color-blue delete_residentials" data-id="{{@$val->id}}"><span>Delete</span>
                    ...
                    <div class="pdf_box">
                    <a href="{{route('user.add.residentials',[@$will_id])}}" class="submit_rm bntt_collor pdf_btn">
                        @if(count(@$properties) > 0)
                        Add another Residential Property
                        @else
...
$(document).ready(function() {
    $('.delete_residentials').click(function() {
        var id = $(this).data('id');
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{url('delete-residentials')}}/" + id;
            } else {
                return false;
            }
        });
