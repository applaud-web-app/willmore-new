@extends('layouts.app')
@section('title','View Commercial Property')
@section('links')
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex nwdes-sec">
                    ...
                    <a href="{{route('user.manage.commercial',[@$will_id])}}" class="top_battn_new">Back to list</a>
                </div>

                @include('includes.message')
                <div class="dash-right-inr">

                    <form id="commercial_form" method="POST" action="{{ route('update.commercial')}}">
                        <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}" id="will_id">
                        <input type="hidden" class="rm_form_fild" name="id" value="{{@$commercialDetail->id}}">
                        @csrf
                        <div class="col-lg-12 col-md-12">
                            <div class="row login_rm02 for_dashboard rr_border">

                                <div class="col-lg-12 col-md-12 beneficiaries_headingg">
                                    <h1>Commercial Property asset</h1>
                                </div>

                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label>Name of the property <span class="text-danger">*</span></label>
                                        <input type="text" name="pname" value="{{@$commercialDetail->name}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" value="{{@$commercialDetail->address}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="commercial_type">
                                            <option value="">Select</option>
                                            <option value="Office" {{@$commercialDetail->commercial_type == 'Office' ? 'selected' : ''}}>Office</option>
                                            <option value="Shop" {{@$commercialDetail->commercial_type == 'Shop' ? 'selected' : ''}}>Shop</option>
                                            <option value="Industrial" {{@$commercialDetail->commercial_type == 'Industrial' ? 'selected' : ''}}>Industrial</option>
                                        </select>
                                    </div>
                                </div>
                                {{--
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="carpet_area" value="{{@$commercialDetail->carpet_area}}" class="rm_form_fild" placeholder="Enter here" min="1">
                                    </div>
                                </div>
                                --}}
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="plot_size" value="{{@$commercialDetail->plot_size}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="ownership_type" id="ownership_type">
                                            <option value="">Select</option>
                                            <option value="Individual" {{@$commercialDetail->ownership_type == 'Individual' ? 'selected' : ''}}> Individual </option>
                                            <option value="Joint" {{@$commercialDetail->ownership_type == 'Joint' ? 'selected' : ''}}> Joint </option>
                                        </select>
                                    </div>
                                </div>

                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group per_hold" @if(@$commercialDetail->ownership_type=='Joint') style="display:block;" @else style="display:none;" @endif>
                                        <label>Percentage Holding (If Joint) <span class="text-danger">*</span></label>
                                        <input type="text" name="percentage_holding" id="percentage_holding" value="{{@$commercialDetail->percentage_holding}}" class="rm_form_fild" placeholder="Enter here" min="1" max="100">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="litigation" value="{{@$commercialDetail->litigation}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jurisdiction" value="{{@$commercialDetail->jurisdiction}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="survey_number" value="{{@$commercialDetail->survey_number}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    @if(@$propertiesl >0)
                                        <a href="{{route('user.manage.land',[@$will_id])}}" class="submit_rm bntt_collor" id="">Skip</a>
                                    @else
                                        <a href="{{route('user.add.land',[@$will_id])}}" class="submit_rm bntt_collor" id="">Skip</a>
                                    @endif

                                    @if(@$properties >0)
                                        <a href="{{route('user.manage.residentials',[@$will_id])}}" class="submit_rm bntt_collor" id="">Back</a>
                                    @else
                                        <a href="{{route('user.add.residentials',[@$will_id])}}" class="submit_rm bntt_collor" id="">Back</a>
                                    @endif
                                </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another commercial property asset, please click "Update" and add another commercial property asset.
                                        If you do not have a commercial property asset, you can press the "Skip" button. </p>
                                </div>
