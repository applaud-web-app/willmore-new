        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="insurance_form" method="POST" action="{{ route('update.insurance')}}">
                        <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}" id="will_id">
                        <input type="hidden" class="rm_form_fild" name="id" value="{{@$insuranceDetail->id}}">
                        @csrf
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                {{-- <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="policy_holder_name"
                                            value="{{@$insuranceDetail->policy_holder_name}}" class="rm_form_fild"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="insurance_company_name"
                                            value="{{@$insuranceDetail->insurance_company_name}}" class="rm_form_fild"
                                            placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="policy_number" value="{{@$insuranceDetail->policy_number}}"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="type">
                                            ...
                                            <option value="Life" {{@$insuranceDetail->type == 'Life' ? 'selected' : ''}}> Life </option>
                                            <option value="Health" {{@$insuranceDetail->type == 'Health' ? 'selected' : ''}}> Health </option>
                                            <option value="Property" {{@$insuranceDetail->type == 'Property' ? 'selected' : ''}}> Property </option>
                                            <option value="Vehicle" {{@$insuranceDetail->type == 'Vehicle' ? 'selected' : ''}}> Vehicle </option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="beneficiar_id">
                                            ...
                                            @foreach(@$beneficiaries as $beneficiar)
                                                <option value="{{$beneficiar->id}}" @if(@$beneficiar->id == @$insuranceDetail->getBeneficiar->beneficiar_id) selected @endif>{{$beneficiar->name}}</option>
                                            @endforeach
                                ...
                                {{-- <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nominee_name" value="{{@$insuranceDetail->nominee_name}}"
                                            class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div> --}}
                                ...
                                {{-- <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="insurance_distribution_plan"
                                            value="{{@$insuranceDetail->insurance_distribution_plan}}" class="rm_form_fild"
                                            placeholder="Enter here">
                                    </div>
                                </div> --}}
