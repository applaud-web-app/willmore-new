        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="locker_form" method="POST" action="{{ route('save.locker')}}">
                    <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label>Locker Number <span class="text-danger">*</span></label>
                                        <input type="text" name="locker_number" value="{{old('locker_number')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                {{--
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="authorized_person" value="{{old('authorized_person')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                --}}
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="passcode" value="{{old('passcode')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label>Key Location</label>
                                        <input type="text" name="key_location" value="{{old('key_location')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="additional_info" value="{{old('additional_info')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
