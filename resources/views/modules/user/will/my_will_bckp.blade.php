                                ...
                                <div class="table_01 table vvr_table_01">
                                    ...
                                    <div class="row small_screen2 for_bg_color_01">
                                        ...
                                        <div class="cel_area amunt-detail cess"> <span class="hide_big">Finalized
                                                ...
                                                ?>
                                                {{$finalize['count']}} out of {{$finalize['total']}}
                                                  </span> </div>
                                        ...
                                        <div class="cel_area amunt-detail cess"> <span class="hide_big">Action</span>
                                            <ul>
                                                ...
                                                @if(@$will->getPackage->packageDetail->id == 1)
                                                    <li><a href="{{route('user.view.will',[@$will->id])}}" class="css-tooltip-top color-blue"><span>View</span><img src="{{asset('public/images/view.png')}}" alt=""></a></li>
                                                @endif

                                                @if(@$will->status == 1  && @$will->approval_status == 3 && @$will->getPackage->packageDetail->id == 1)
                                                    <li><a href="{{route('user.manage.executor',[@$will->id])}}" class="css-tooltip-top color-blue"><span>Complete Will</span><img src="{{asset('public/images/create-will.png')}}" alt=""></a></li>
                                                @endif

                                                @if(@$will->getPackage->packageDetail->id == 1 && @$will->status == 1)
                                                    <li><a href="{{route('user.changes.suggested',[@$will->id])}}" class="css-tooltip-top color-blue wertttt"><span>Changes Suggested By Admin</span><img src="{{asset('public/images/changes_suggested.png')}}" alt=""></a></li>
                                                @endif
                                                ...
                                                @if(@$will->status == 1 && @$will->approval_status == 3 && checkWillExist(@$will->id))
                                                    ...
                                                    <li><a href="{{route('user.add.will.location',[@$will->id])}}" class="css-tooltip-top color-blue"><span>Upload Final Will</span> <img src="{{asset('public/images/upp.png')}}" alt=""></a></li>
                                                @endif

                                                @if(@$will->status == 3)
                                                    <li><a href="{{route('user.add.will.location',[@$will->id])}}" class="css-tooltip-top color-blue"><span>View Uploaded Will</span> <img src="{{asset('public/images/upp.png')}}" alt=""></a></li>
                                                @endif

                                                @if(checkWillExist(@$will->id))
                                                    <li><a href="javascript:;" data-id="{{@$will->id}}" class="css-tooltip-top color-blue pdf_alrt"><span>Generate and Download PDF</span> <img src="{{asset('public/images/pdf.png')}}" alt=""></a></li>
                                                @endif

                                                {{-- Package 2 --}}

                                                @if(@$will->getPackage->packageDetail->id == 2)
                                                    <li><a href="{{route('user.add.will.location',[@$will->id])}}" class="css-tooltip-top color-blue"><span>Enter Location Info</span> <img src="{{asset('public/images/dp03.png')}}" alt=""></a></li>
                                                @endif

                                                @if(@$will->getPackage->packageDetail->id == 2 )
                                                    <li><a href="{{route('user.manage.executor',[@$will->id])}}" class="css-tooltip-top color-blue"><span>Executor of location storage</span><img src="{{asset('public/images/pp_me.png')}}" alt=""></a></li>
                                                @endif

                                                {{-- Package 3 --}}

                                                @if(@$will->getPackage->packageDetail->id == 3)
                                                    <li><a href="{{route('user.add.will.location',[@$will->id])}}" class="css-tooltip-top color-blue"><span>Upload LOI</span> <img src="{{asset('public/images/upp.png')}}" alt=""></a></li>
                                                @endif

                                                @if(@$will->getPackage->packageDetail->id == 3 )
                                                    <li><a href="{{route('user.manage.executor',[@$will->id])}}" class="css-tooltip-top color-blue"><span>Access of LOI</span><img src="{{asset('public/images/acceptt.png')}}" alt=""></a></li>
                                                @endif
