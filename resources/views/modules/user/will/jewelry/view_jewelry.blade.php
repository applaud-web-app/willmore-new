        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="jewelry_form" method="POST" action="{{ route('update.jewelry')}}">
                        @csrf
                        <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}" id="will_id">
                        <input type="hidden" class="rm_form_fild" name="id" value="{{@$jewelryDetail->id}}">
                            ...
                            <span class="error main_err ml-3 mb-2" style="display:none;">Please fill atleast one of these fields - <strong>Gold Weight</strong>, <strong>Silver Weight</strong> or <strong>Description</strong></span>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gold_weight" id="gold_weight" value="{{number_format(@$jewelryDetail->gold_weight,0,'','')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="silver_weight" id="silver_weight" value="{{number_format(@$jewelryDetail->silver_weight,0,'','')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" name="address" value="{{@$jewelryDetail->address}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <div class="form-group">
                                        ...
                                        {{-- <input type="text" name="description" id="description" value="{{@$jewelryDetail->description}}" class="rm_form_fild" placeholder="Enter here"> --}}
                                            <textarea class="rm_form_fild rm_form_fild_trr" name="description" id="description"
                                            placeholder="Write here"  style="height: 92px;">{{@$jewelryDetail->description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-9 col-md-9">
                                    <div class="form-group">
                                        <label>Location <span class="text-danger">*</span></label>
                                        <input type="text" name="location" value="{{@$jewelryDetail->location}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another jewellery asset, please click "Update" and add another jewellery asset.
...
<script>
    ...
    $(document).on('click','.edit_alo', function(e){
        ...
        $.ajax({
            url: '{{ route('edit.jewelry.allocation') }}',
            method: 'GET',
            data: 'id='+id,
