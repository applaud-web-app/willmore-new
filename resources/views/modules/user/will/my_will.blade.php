...
@section('content')
    ...
    <div class="inner_page_area dashboard_inner">
        <div class="container bottom-50">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12">
                    ...
                    <div class="dash-right-inr">
                                ...
                                <div class="row login_rm02 for_dashboard services_page">
                                    ...
                                    <div class="refinee03">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="from_date" value="{{ @$key['from_date'] }}"
                                                class="rm_form_fild calandar_iconn" placeholder="Select" id="datepicker">
                                        </div>
                                    </div>
                                    ...
                                    <div class="refinee03">
                                        <div class="form-group">
                                            <label>To date</label>
                                            <input type="text" name="to_date" value="{{ @$key['to_date'] }}"
                                                class="rm_form_fild calandar_iconn" placeholder="Select" id="datepicker2">
                                        </div>
                                    </div>
                                    ...
                                    <div class=" refinee03">
                                        <div class="form-group">
                                            ...
                                            <select class="rm_form_fild" name="status">
                                                ...
                                                <option value="1" {{ @$key['status'] == 1 ? 'selected' : '' }}>In
                                                    Progess</option>
                                                {{-- <option value="2" {{@$key['status'] == 2 ? 'selected' : ''}}>Finalized</option> --}}
                                                <option value="3" {{ @$key['status'] == 3 ? 'selected' : '' }}>
                                                    Completed</option>
                                            </select>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="clm-pp-top">
                                                                        <h5>
                                                                            ...
                                                                            @if (@$will->getPackage->master_will_id != null)
                                                                                <span>Master ID :
                                                                                    <strong>#{{ @$will->getPackage->master_will_id }}</strong></span>
                                                                            @endif
                                                                        </h5>
                                                                        <?php
                                                                        ...
                                                                        <h4>
                                                                            <span>{{ $finalize['count'] }}/{{ $finalize['total'] }}
                                                                                completed</span>
                                                                            <strong>
                                                                                @switch(@$will->status)
                                                                                    @case(1)
                                                            ...
                                                            @endif --}}
                                                                            @if (@$will->status == 1 && @$will->approval_status == 3 && @$will->getPackage->packageDetail->id == 1)
                                                                                <li>
                                                                                    ...
                                                                                    @if (checkWillExist(@$will->id) ||
                                                                                            checkBeneficiarExist(@$will->id) ||
                                                                                            checkExecutorsExist(@$will->id) ||
                                                                                            checkWitnessExist(@$will->id))
                                                                                        <?php
                                                                                        $completeWillUrl = getCompleteWillUrl(@$will->id);
                                                                                        ?>
                                                                                        <a href="{{ @$completeWillUrl }}"
                                                                                            class="top_battn_new">Complete
                                                                                            Will</a>
                                                                                    @else
                                                                                        {{-- <a href="{{route('user.manage.executor',[@$will->id])}}" class="top_battn_new">Start Will</a> --}}
                                                                                        <a href="{{ route('introduction', [@$will->id]) }}"
                                                                                            class="top_battn_new">Start
                                                                                            Will</a>
                                                                                    @endif
                                                                                </li>
                                                                            @endif
                                                                            ...
                                                                            @if (@$will->status == 1 && @$will->approval_status == 3 && checkWillExist(@$will->id))
                                                                                <li><a href="{{ route('user.add.will.location', [@$will->id]) }}"
                                                                                        class="top_battn_new">Upload Final
                                                                                        Will</a></li>
                                                                            @endif

                                                                            @if (@$will->status == 3)
                                                                                <li><a href="{{ route('user.add.will.location', [@$will->id]) }}"
                                                                                        class="top_battn_new">View Uploaded
                                                                                        Will</a></li>
                                                                                <li><a href="{{ route('user.manage.executor', [@$will->id]) }}"
                                                                                        class="top_battn_new">Edit Will</a>
                                                                                </li>
                                                                            @endif
                                                                            ...
                                                                            @if (checkWillExist(@$will->id) &&
                                                                                    checkBeneficiarExist(@$will->id) &&
                                                                                    checkExecutorsExist(@$will->id) &&
                                                                                    checkWitnessCount(@$will->id) > 1)
                                                                                <li><a href="javascript:;"
                                                                                        data-id="{{ @$will->id }}"
                                                                                        class="top_battn_new css-tooltip-top color-blue pdf_alrt">Generate
                                                                                        and Download PDF</a></li>
                                                                            @endif
                                                                        </ul>
                                                                    </div>
                                                                </div>
                        ...
                        <a href="javascript:;" class="readMore moreless-button willReadMore" id="readMoreBtn"
                            @if ($count1 == 0 || $count1 == 1) style="display:none;" @endif>Show more</a>
                                            ...
                                            <div class="clm-pp-btns">
                                                ...
                                                <ul>
                                                    @if (@$will->getPackage->packageDetail->id == 3 && checkWillAccess(@$will->id))
                                                        <li><a href="{{ route('user.service.authorized', [@$will->id]) }}"
                                                                class="top_battn_new">Nominee</a></li>
                                                    @endif

                                                    @if (@$will->getPackage->packageDetail->id == 3 && !checkWillAccess(@$will->id) && $finalize['count'] == 1)
                                                        <li><a href="{{ route('user.service.authorized', [@$will->id]) }}"
                                                                class="top_battn_new">Add Nominee</a></li>
                                                    @endif
                                                        ...
                                                        <li>
                                                            @if ($finalize['count'] < 1)
                                                                <a href="{{ route('introduction', [@$will->id]) }}"
                                                                    ...
                                                                    Upload LOI
                                                                @else
                                                                    <a href="{{ route('user.add.will.location', [@$will->id]) }}"
                                                                        class="top_battn_new">
                                                                        View Uploaded LOI
                                                            @endif
                                                            </a>
            ...
            @endforeach
            <a href="javascript:;" class="readMore moreless-button willReadMore" id="readMoreBtn"
                @if ($count2 == 0 || $count2 == 1) style="display:none;" @endif>Show more</a>
            @endif
            @if (@$count2 == 0)
                <div class="clm-paper">
                    <div class="clm-pp-btns">
    ...
    @if (@$totalWillPkg2 > 0)
        <div class="col-lg-4 col-md-4">
            <div class="will-clm-box lst-clm">
                <h3>
                    <img src="{{ asset('public/images/will-location.png') }}" alt="icon"> Will location
                </h3>
                <div class="will-clm-inr team-text team-text2">
                    <?php $count3 = 0; ?>
                    @if (count(@$wills) > 0)
    ...
    @endforeach
    <a href="javascript:;" class="readMore moreless-button willReadMore" id="readMoreBtn"
        @if ($count3 == 0 || $count3 == 1) style="display:none;" @endif>Show more</a>
    @endif
    @if (@$count3 == 0)
        <div class="clm-paper">
            <div class="clm-pp-btns">
    ...
    @if (@$totalWillPkg5 > 0)
        <div class="col-lg-4 col-md-4">
            <div class="will-clm-box lst-clm">
                <h3>
                    <img src="{{ asset('public/images/will-location.png') }}" alt="icon"> Advance Medical Directive
                </h3>
                <div class="will-clm-inr team-text team-text2">
                    <?php $count5 = 0; ?>
                    @if (count(@$wills) > 0)
                                    ...
                                    <div class="clm-pp-btns">
                                        ...
                                        <ul>
                                            @if (@$will->getPackage->packageDetail->id == 5 && checkWillAccess(@$will->id))
                                                <li><a href="{{ route('user.service.authorized', [@$will->id]) }}"
                                                        class="top_battn_new">Trusted Person </a></li>
                                            @endif

                                            @if (@$will->getPackage->packageDetail->id == 5 && !checkWillAccess(@$will->id) && $finalize['count'] == 1)
                                                <li><a href="{{ route('user.service.authorized', [@$will->id]) }}"
                                                        class="top_battn_new">Add Trusted Person </a></li>
                                            @endif
                                                ...
                                                <li>
                                                    @if ($finalize['count'] < 1)
                                                        <a href="{{ route('introduction', [@$will->id]) }}"
                                                            ...
                                                            Upload AMD
                                                        @else
                                                            <a href="{{ route('user.add.amd', [@$will->id]) }}"
                                                                class="top_battn_new">
                                                                View AMD
                                                    @endif
                                                    </a>
    ...
    @endforeach
    <a href="javascript:;" class="readMore moreless-button willReadMore" id="readMoreBtn"
        @if ($count5 == 0 || $count5 == 1) style="display:none;" @endif>Show more</a>
    @endif
    @if (@$count5 == 0)
        <div class="clm-paper">
            <div class="clm-pp-btns">
...
@else
    <div class="col-lg-12 mt-1 mb-4">
        <div class="row align-items-strech">
            <p>You have not purchased any package. Please <a style="color:#f43930;text-decoration:underline;"
                    href="{{ route('services') }}">Click here</a> to purchase a package.</p>
        </div>
    </div>
    @endif
