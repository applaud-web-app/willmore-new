        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="contingency_form" method="POST" action="{{ route('save.contingency')}}">
                        @csrf
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="rm_form_fild rm_form_fild_trr" name="details"
                                            placeholder="Write the contingency clause and who will get the assets of the beneficiary">{{old('details')}}</textarea>
                                    </div>
                                </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another contingency, please click "Save" and add another contingency.</p>
                                </div>
