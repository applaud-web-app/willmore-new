@extends('layouts.app')
@section('title','Add Demat Account')
@section('links')
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="demat_form" method="POST" action="{{ route('save.demat')}}">
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dp_name" value="{{old('dp_name')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dp_id" value="{{old('dp_id')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label>Client ID / Demat Account Number <span class="text-danger">*</span></label>
                                        <input type="text" name="demat_account_number" value="{{old('demat_account_number')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="custodian" value="{{old('custodian')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>

                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label> Equity 1 to N <span class="text-danger">*</span></label>
                                        <input type="text" name="equity" value="{{old('equity')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="quantity" value="{{old('quantity')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>--}}
                                ...
                                {{--<div class="col-lg-8 col-md-6">
                                    <div class="form-group eandq">
                                        ...
                                        <textarea name="equity" class="rm_form_fild" placeholder="Enter here" style="height: 73px !important;">{{old('equity')}}</textarea>
                                    </div>
                                </div>--}}
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another demat account, please click "Save" and add another demat account.
