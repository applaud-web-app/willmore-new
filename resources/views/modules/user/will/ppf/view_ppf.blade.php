        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex nwdes-sec">
                    <h2> Edit PPF Account</h2>
                    <p>If you wish to add a new beneficiary please add that before adding the asset details.</p>
                    <a href="{{route('user.manage.ppf',[@$will_id])}}" class="top_battn_new">Back to list</a>
                </div>

                @include('includes.message')
                <div class="dash-right-inr">

                    <form id="ppf_form" method="POST" action="{{ route('update.ppf')}}">
                        <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}" id="will_id">
                        <input type="hidden" class="rm_form_fild" name="id" value="{{@$ppfDetail->id}}">
                        @csrf
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label>PPF Account Name <span class="text-danger">*</span></label>
                                        <input type="text" name="account_name"
                                            value="{{@$ppfDetail->account_name}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>

                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        <label>PPF Account Number <span class="text-danger">*</span></label>
                                        <input type="text" name="account_number"
                                            value="{{@$ppfDetail->account_number}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_name"
                                            value="{{@$ppfDetail->bank_name}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="branch_address"
                                            value="{{@$ppfDetail->branch_address}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                {{-- <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nominee_name"
                                            value="{{@$ppfDetail->nominee_name}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div> --}}
                                {{--
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="start_date"
                                            value="{{@$ppfDetail->start_date}}" class="rm_form_fild calandar_iconn"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="end_date"
                                            value="{{@$ppfDetail->end_date}}" class="rm_form_fild calandar_iconn"
                                            placeholder="Enter here" id="datepicker2">
                                    </div>
                                </div>
                                --}}
                                <div class="w-100"></div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    @if(@$vehicles >0)
                                        <a href="{{route('user.manage.vehicles',[@$will_id])}}" class="submit_rm bntt_collor" id="">Skip</a>
                                    @else
                                        <a href="{{route('user.add.vehicles',[@$will_id])}}" class="submit_rm bntt_collor" id="">Skip</a>
                                    @endif

                                    @if(@$insurance >0)
                                        <a href="{{route('user.manage.insurance',[@$will_id])}}" class="submit_rm bntt_collor" id="">Back</a>
                                    @else
                                        <a href="{{route('user.add.insurance',[@$will_id])}}" class="submit_rm bntt_collor" id="">Back</a>
                                    @endif
                                </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another ppf account, please click "Save" and add another ppf account.
                                        If you do not have a ppf account, you can press the "Skip" button. </p>
                                </div>
...
$(document).ready(function() {
    ...
    $.validator.addMethod("accno_Regex", function(value, element) {
    ...
    $("#ppf_form").validate({
        rules: {
            ...
            account_number: {
                required: true,
                //number: true,digits: true,maxlength:30
                accno_Regex: true,maxlength:30
            },
            branch_address: {
            ...
            // },
            // start_date: {
            //     required: true,smallerThan: "#datepicker2"
            // },
            // end_date: {
            //     required: true,greaterThan: "#datepicker"
            // },
            share_detail: {
                maxlength: 200,
                minlength: 3
        ...
        messages: {
            account_name: {
                ...
                name_Regex: 'PPF Account Name must contain only letters',
            },
            account_number: {
