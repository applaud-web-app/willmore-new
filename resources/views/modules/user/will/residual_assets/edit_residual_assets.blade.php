        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="residual_form" method="POST" action="{{ route('update.residualAssets')}}">
                        @csrf
                        <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}" id="will_id">
                        <input type="hidden" class="rm_form_fild" name="id" value="{{@$residualDetail->id}}">
                        <div class="col-lg-12 col-md-12">
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="beneficiar_id" id="bene">
                                            ...
                                            <option value="{{@$residualDetail->beneficiar_id}}" id="shop-n" selected>{{@$residualDetail->getBeneficiar->name}}</option>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another residual asset, please click "Update" and add another residual asset.
