@extends('layouts.app')
@section('title','Add Mutual Funds and Bonds')
@section('links')
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex nwdes-sec">
                    <h2> Add Mutual Funds and Bonds</h2>
                    <p>If you wish to add a new beneficiary please add that before adding the asset details.</p>
                    <a href="{{route('user.manage.mutualFund',[@$will_id])}}" class="top_battn_new">Back to list</a>
                </div>

                @include('includes.message')
                <div class="dash-right-inr">

                    <form id="mutualFund_form" method="POST" action="{{ route('save.mutualFund')}}">
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="investment_banker" value="{{old('investment_banker')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_name" value="{{old('account_name')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_number" value="{{old('account_number')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_of_units" value="{{old('number_of_units')}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another mutual fund, please click "Save" and add another mutual fund.
