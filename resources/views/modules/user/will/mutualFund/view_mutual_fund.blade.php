@extends('layouts.app')
@section('title','View Mutual Funds and Bonds')
@section('links')
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                <div class="cus-dashboard-right didlex nwdes-sec">
                    <h2> Edit Mutual Funds and Bonds</h2>
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="mutualFund_form" method="POST" action="{{ route('update.mutualFund')}}">
                        <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}" id="will_id">
                        <input type="hidden" class="rm_form_fild" name="id" value="{{@$mutualFundDetail->id}}">
                        @csrf
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="investment_banker" value="{{@$mutualFundDetail->investment_banker}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_name" value="{{@$mutualFundDetail->account_name}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_number" value="{{@$mutualFundDetail->account_number}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number_of_units" value="{{@$mutualFundDetail->number_of_units}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="ownership_type" id="ownership_type">
                                            ...
                                            <option value="Individual" {{@$mutualFundDetail->ownership_type == 'Individual' ? 'selected' : ''}}> Individual </option>
                                            <option value="Joint" {{@$mutualFundDetail->ownership_type == 'Joint' ? 'selected' : ''}}> Joint </option>
                                        </select>
                                    </div>
                                </div>

                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group per_hold" @if(@$mutualFundDetail->ownership_type=='Joint') style="display:block;" @else style="display:none;" @endif>
                                        <label>Percentage Holding (If Joint) <span class="text-danger">*</span></label>
                                        <input type="text" name="percentage_holding" id="percentage_holding" value="{{@$mutualFundDetail->percentage_holding}}" class="rm_form_fild" placeholder="Enter here" min="1" max="100">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="form-group">
                                        <label>Address of the Bank/Advisory<span class="text-danger">*</span></label>
                                        <input type="text" name="address" value="{{@$mutualFundDetail->address}}" class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    @if(@$insurance >0)
                                        <a href="{{route('user.manage.insurance',[@$will_id])}}" class="submit_rm bntt_collor" id="">Skip</a>
                                    @else
                                        <a href="{{route('user.add.insurance',[@$will_id])}}" class="submit_rm bntt_collor" id="">Skip</a>
                                    @endif

                                    @if(@$demat >0)
                                        <a href="{{route('user.manage.demat',[@$will_id])}}" class="submit_rm bntt_collor" id="">Back</a>
                                    @else
                                        <a href="{{route('user.add.demat',[@$will_id])}}" class="submit_rm bntt_collor" id="">Back</a>
                                    @endif
                                </div>
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another mutual fund, please click "Update" and add another mutual fund.
                                        If you do not have a mutual fund, you can press the "Skip" button. </p>
                                </div>
    ...
    $("#mutualFund_form").validate({
        ...
        messages: {
            account_name: {
                ...
                name_Regex: 'Scheme Name must contain only letters',
            },
            account_number: {
            ...
            investment_banker: {
                name_Regex: 'Fund Name must contain only letters',
                maxlength: 'Please enter not more than 100 characters'
            },
            address: {
