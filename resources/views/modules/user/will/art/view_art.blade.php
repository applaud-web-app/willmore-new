        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
                ...
                <div class="dash-right-inr">
                    ...
                    <form id="art_form" method="POST" action="{{ route('update.art')}}">
                        <input type="hidden" class="rm_form_fild" name="will_id" value="{{@$will_id}}" id="will_id">
                        <input type="hidden" class="rm_form_fild" name="id" value="{{@$artDetail->id}}">
                        @csrf
                            ...
                            <div class="row login_rm02 for_dashboard rr_border">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="rm_form_fild" name="type">
                                            ...
                                            <option value="Painting" {{@$artDetail->type == 'Painting' ? 'selected' : ''}}>Painting</option>
                                            <option value="Sculpture" {{@$artDetail->type == 'Sculpture' ? 'selected' : ''}}>Sculpture</option>
                                            <option value="Other" {{@$artDetail->type == 'Other' ? 'selected' : ''}}>Other</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="art_name" value="{{@$artDetail->art_name}}"
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" value="{{@$artDetail->location}}"
                                            class="rm_form_fild" placeholder="Enter here">
                                    </div>
                                </div>
                                        ...
                                        @foreach(@$UserAssetsBeneficiaries as $val)
                                            <div class="col-lg-12 col-md-12">
                                                <div class="added_beneficiariess">
                                                    ...
                                                    @if(@$val->share_detail)<P>Shares allocated : {{@$val->share_detail}}</P>@endif
                                                    ...
                                                    <a href="javascript:;" class="top_battn_new css-tooltip-top color-blue remCF top_battn_new">Reallocate</a>
                                                </div>
                                            </div>
                                        @endforeach
                                        @endif
                                ...
                                @include('includes.download_pdf_btn')
                                    ...
                                    <p>If you wish to add another art asset, please click "Update" and add another art asset.
    ...
    if(beneficiarID.length > 0 && share_detail.length > 2){
      var html = `<div class="col-lg-12 col-md-12">
                    <div class="added_beneficiariess">
                        ...
                        <a href="javascript:;" class="css-tooltip-top color-blue remCF">Reallocate</a>
                    </div>
                </div>`;
