...
class DisputeAcceptOffer extends Mailable
{
    ...
    public function build()
    {
        ...
        $template = EmailTemplate::where('id',32)->first();
        ...
        $mailBody = str_replace('_PROJECTNAME_', $this->request['project_title'], $mailBody); 
