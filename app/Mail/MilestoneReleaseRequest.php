...
class MilestoneReleaseRequest extends Mailable
{
    ...
    public function build()
    {
        ...
        $mailBody = str_replace('_FREELANCER_', $this->request['freelancer'], $mailBody);
        ...
        $mailSub = str_replace('_FREELANCER_', $this->request['freelancer'], $mailSub);
