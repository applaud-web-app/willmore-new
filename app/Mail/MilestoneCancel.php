...
class MilestoneCancel extends Mailable
{
    ...
    public function build()
    {
        ...
        $mailBody = str_replace('_EMPLOYERUSERNAME_', $this->request['freelancer'], $mailBody);
        ...
        $mailSub = str_replace('_EMPLOYERUSERNAME_', $this->request['freelancer'], $mailSub);
