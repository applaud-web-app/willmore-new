    ...
    public function customLogin(Request $request)
    {
        ...
        if(@$mainWill){
            ...
            if($packeg->package_id ==1){
                ...
                $existExeAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'E')->where('access_type', 'W')->first();
                $existBenAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'B')->where('access_type', 'W')->pluck('ben_id')->toArray();

                // dd($existExeAccess);
                if($isEmail){
                    $executor = Executor::where('id', @$existExeAccess->exe_id)->Where('email', @$request->mobile)->first();
                    $beneficiaries = Beneficiaries::whereIn('id', @$existBenAccess)->Where('email', @$request->mobile)->first();

                }else{
                    $executor = Executor::where('id', @$existExeAccess->exe_id)->where('mobile', @$request->mobile)->first();
                    $beneficiaries = Beneficiaries::whereIn('id', @$existBenAccess)->where('mobile', @$request->mobile)->first();
            ...
            if($packeg->package_id == 2){
                ...
                $existExeAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'E')->where('access_type', 'L')->first();
                $existBenAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'B')->where('access_type', 'L')->pluck('ben_id')->toArray();
            ...
            if($packeg->package_id == 3){
                ...
                $existExeAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'E')->where('access_type', 'LI')->first();
                $existBenAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'B')->where('access_type', 'LI')->pluck('ben_id')->toArray();
            ...
            if($packeg->package_id == 5){

                $existExeAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'E')->where('access_type', 'AMD')->first();
                $existBenAccess = WillDownloadAccess::where('will_id', $mainWill->id)->where('user_type', 'B')->where('access_type', 'AMD')->pluck('ben_id')->toArray();
