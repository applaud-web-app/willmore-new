...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        //custom middleware
        'check.will' => \App\Http\Middleware\CheckWillExists::class,
        'check.exe' => \App\Http\Middleware\CheckExeExists::class,
        'check.ben' => \App\Http\Middleware\CheckBenExists::class,
