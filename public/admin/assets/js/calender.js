...
class CalendarYvv{
	constructor(etiqueta="", diaSeleccionado="", primerDia="Lunes") {
		this.etiqueta = etiqueta; // etiqueta donde se mostrarÃ¡
		this.primerDia = primerDia; // inicio de la semana
		this.diaSeleccionado = diaSeleccionado==""?moment().format("Y-M-D"):diaSeleccionado; // dÃ­a actual seleccionado
	...
	startElements(){
		...
		this.anioSeleccionado = this.diaSeleccionado.split("-")[0]*1; // aÃ±o seleccionado
